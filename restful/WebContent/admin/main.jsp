...
<script type="text/javascript">
	...
	function openPasswordModifyDialog(){
		...
		url="${pageContext.request.contextPath}/web?method=modpwd&id=${user.id}";
	}
	...
	function modifyPassword(){
		$("#fm").form("submit",{
			...
			onSubmit:function(){
				...
				{
				  	$.messager.alert("系统提示","原密码输入错误，不能修改！");
				  	return false;
				}
	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${user.name}</font>
			</td>
		</tr>
	</table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<div title="学生信息管理"  data-options="iconCls:'icon-plgl'" style="padding:10px">
			<a href="javascript:openTab('学生信息管理','amManage.jsp','icon-plgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-plgl'" style="width: 150px;">学生信息管理</a>
		</div>
