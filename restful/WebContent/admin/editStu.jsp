...
<script type="text/javascript">
	function submitData(){
		...
		if(name==null || name==''){
			...
			$.post("${pageContext.request.contextPath}/student/",{'id':'${param.id}','name':name,'password':password,'phone':phone,'address':address,'cardno':cardno,'realname':realname,'sex':sex,'ctime':ctime,'stuno':stuno,'memo':memo},function(result){
				if(result){
					alert("保存成功！");
					//resetValue();
				}else{
...
<script type="text/javascript">
$.ajax({  
    url: "${pageContext.request.contextPath}/student/${param.id}",    
    type: "GET",  
    dataType: "json",  
